...
public class MessageServiceImpl implements MessageService, BeanReload, BeanConfigure<MessageService> {
	...
	public String getRequestLanguage() {
		String languageCode = RequestContext.currentContext().getAttribute(MessageHandler.Attribute.LANGUAGE);
	...
	@Override
	public void setRequestLanguage() {
		RequestContext context = RequestContext.currentContext();
		String language = RequestUtil.getHeader(context.getRequest(), HttpHeaders.ACCEPT_LANGUAGE, "");
		...
		context.setAttribute(MessageHandler.Attribute.LANGUAGE, language);
	}
